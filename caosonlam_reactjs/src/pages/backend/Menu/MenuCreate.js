...
function MenuCreate() {
    ...
    const handleAddMenu = async (e) => {
        ...
        try {
            ...
            navigate('/admin/menu'); // Điều hướng về trang danh sách menu sau khi thêm thành công
        } catch (error) {
    ...
    return (
        <div className="max-w-xl mx-auto mt-10 p-6 bg-gray-100 rounded-lg shadow-md">
            <h2 className="text-2xl font-semibold text-gray-700 mb-6 text-center">Create Menu</h2>
            ...
            <form onSubmit={handleAddMenu} className="space-y-4">
                ...
                {/* <div className="form-group">
                    <label className="block text-gray-600 mb-1">Người tạo:</label>
                    <input
                        type="text"
                        name="created_by"
                ...
                <div className="form-group">
                    <label className="block text-gray-600 mb-1">Người cập nhật:</label>
                    <input
                        type="text"
                        name="updated_by"
